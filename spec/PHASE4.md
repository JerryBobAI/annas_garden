...
- [ ] 任务模式：连续答对 3 次 → 下次题目变难
- [ ] 任务模式：连续答错 2 次 → 下次题目变简单
- [ ] 首页推荐：显示"推荐学习 XXX"
- [ ] 家长面板：周报内容准确、建议合理
- [ ] 内容导入：文本 → AI 提取 → 确认 → 关联目标
- [ ] 花园区域：解锁条件达标 → 新区域出现
- [ ] 季节效果：不同月份显示不同背景
...
- [ ] **S2**: 连续答对 → 难度自动提升
- [ ] **S3**: 连续答错 → 难度自动降低 + 鼓励
- [ ] **S4**: 认知档案自动更新（偏好、兴趣、专注度）
- [ ] **S5**: 首页显示 AI 推荐的学习任务

- [ ] **P1**: 家长看到 AI 生成的周报
- [ ] **P2**: 周报包含知识掌握趋势 + 兴趣 + 建议
- [ ] **P3**: 家长可导入文本内容 → AI 提取知识点
- [ ] **P4**: 导入内容关联到任务模式
...
- [ ] **PU1**: 家长首页数据全部实时查询（无硬编码）
- [ ] **PU2**: 家长首页显示 AI 快报摘要
- [ ] **PU3**: 学期目标每个知识点显示掌握度进度条
- [ ] **PU4**: 学习计划显示 AI 推荐补充任务
- [ ] **PU5**: 系统设置显示认知档案
- [ ] **PU6**: 导出功能可用（JSON 下载）
- [ ] **PU7**: 内容管理有 AI 导入入口
- [ ] **PU8**: npm run build 通过
